...
def main():
    ...
    print('\n') 
    print(lG+'------------------DRACKYJR---------------------')                                      
    print(lC+'_________________PBL KBTCOE____________________')
    print(lC+'___________________MEMBERS_____________________')
    print(lC+'_______________DIKSHA BHADANE__________________')
    print(lC+'_______________RUTUJA GANGURDE_________________')
    print(lC+'________________RAJAT KULKARNI_________________')
    print(lC+'_________________PRANAV PAWAR__________________')
    print('\n')
